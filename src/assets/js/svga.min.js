!function(e, t) {
    ...
    return function(e) {
        ...
        "use strict";
        var i, n, o = e.exports = r(2), s = r(20);
        o.codegen = r(47),
        o.fetch = r(48),
        o.path = r(49),
        o.fs = o.inquire("fs"),
    ...
    , function(e, t, r) {
        ...
        function i(e, t, r) {
            ...
            t)
                for (var i = Object.keys(t), o = 0; o < i.length; ++o)
                    "number" == typeof t[i[o]] && (this.valuesById[this.values[i[o]] = t[i[o]]] = i[o])
        }
        e.exports = i;
        var n = r(3);
        ...
        i.fromJSON = function(e, t) {
            var r = new i(e,t.values,t.options);
            return r.reserved = t.reserved,
            r
        }
        ,
        i.prototype.toJSON = function() {
            return s.toObject(["options", this.options, "values", this.values, "reserved", this.reserved && this.reserved.length ? this.reserved : void 0])
        }
        ,
    ...
    , function(e, t, r) {
        ...
        (function(e) {
            ...
            o.isNode = Boolean(e.process && e.process.versions && e.process.versions.node),
    ...
    , function(e, t, r) {
        ...
        var o, s = r(1), a = r(7), f = r(0), l = /^required|optional|repeated$/;
        i.fromJSON = function(e, t) {
        ...
        ,
        i.prototype.toJSON = function() {
            return f.toObject(["rule", "optional" !== this.rule && this.rule || void 0, "type", this.type, "id", this.id, "extend", this.extend, "options", this.options])
        }
        ,
        i.prototype.resolve = function() {
            if (this.resolved)
    ...
    , function(e, t, r) {
        ...
        n.prototype.toJSON = function() {
            return h.toObject(["options", this.options, "nested", i(this.nestedArray)])
        }
        ,
        n.prototype.addJSON = function(e) {
            ...
            if (e)
                for (var r, i = Object.keys(e), o = 0; o < i.length; ++o)
                    r = e[i[o]],
                    t.add((void 0 !== r.fields ? a.fromJSON : void 0 !== r.values ? l.fromJSON : void 0 !== r.methods ? f.fromJSON : void 0 !== r.id ? u.fromJSON : n.fromJSON)(i[o], r));
            return this
        }
        ,
    ...
    , function(e, t, r) {
        ...
        e.exports = s;
        var c, d = r(2), p = d.LongBits, y = d.base64, m = d.utf8;
        s.create = d.Buffer ? function() {
        ...
        s.prototype.uint32 = function(e) {
            return this.len += (this.tail = this.tail.next = new l((e >>>= 0) < 128 ? 1 : e < 16384 ? 2 : e < 2097152 ? 3 : e < 268435456 ? 4 : 5,e)).len,
            this
        }
        ,
    ...
    , function(e, t, r) {
        ...
        e.exports = n;
        var f, l = r(2), u = l.LongBits, h = l.utf8, c = "undefined" != typeof Uint8Array ? function(e) {
    ...
    , function(e, t, r) {
        ...
        function n(e) {
            for (var t, r, n = a.codegen(["m", "w"], e.name + "$encode")("if(!w)")("w=Writer.create()"), f = e.fieldsArray.slice().sort(a.compareFieldsById), t = 0; t < f.length; ++t) {
                ...
                l.map ? (n("if(%s!=null&&m.hasOwnProperty(%j)){", r, l.name)("for(var ks=Object.keys(%s),i=0;i<ks.length;++i){", r)("w.uint32(%i).fork().uint32(%i).%s(ks[i])", (l.id << 3 | 2) >>> 0, 8 | s.mapKey[l.keyType], l.keyType),
                void 0 === c ? n("types[%i].encode(%s[ks[i]],w.uint32(18).fork()).ldelim().ldelim()", u, r) : n(".uint32(%i).%s(%s[ks[i]]).ldelim()", 16 | c, h, r),
                n("}")("}")) : l.repeated ? (n("if(%s!=null&&%s.length){", r, r),
                l.packed && void 0 !== s.packed[h] ? n("w.uint32(%i).fork()", (l.id << 3 | 2) >>> 0)("for(var i=0;i<%s.length;++i)", r)("w.%s(%s[i])", h, r)("w.ldelim()") : (n("for(var i=0;i<%s.length;++i)", r),
                void 0 === c ? i(n, l, u, r + "[i]") : n("w.uint32(%i).%s(%s[i])", (l.id << 3 | c) >>> 0, h, r)),
                n("}")) : (l.optional && n("if(%s!=null&&m.hasOwnProperty(%j))", r, l.name),
                void 0 === c ? i(n, l, u, r) : n("w.uint32(%i).%s(%s)", (l.id << 3 | c) >>> 0, h, r))
            }
            return n("return w")
        }
        e.exports = n;
    ...
    , function(e, t, r) {
        ...
        i.prototype.toJSON = function() {
            ...
            return p.toObject(["options", e && e.options || void 0, "oneofs", o.arrayToJSON(this.oneofsArray), "fields", o.arrayToJSON(this.fieldsArray.filter(function(e) {
                return !e.declaringField
            })) || {}, "extensions", this.extensions && this.extensions.length ? this.extensions : void 0, "reserved", this.reserved && this.reserved.length ? this.reserved : void 0, "group", this.group || void 0, "nested", e && e.nested || void 0])
        }
        ,
    ...
    , function(e, t, r) {
        ...
        i.prototype.toJSON = function() {
            var e = o.prototype.toJSON.call(this);
            return a.toObject(["options", e && e.options || void 0, "methods", o.arrayToJSON(this.methodsArray) || {}, "nested", e && e.nested || void 0])
        }
        ,
    ...
    , function(e, t, r) {
        ...
        var o = r(0);
        i.fromJSON = function(e, t) {
            return new i(e,t.type,t.requestType,t.responseType,t.requestStream,t.responseStream,t.options)
        }
        ,
        i.prototype.toJSON = function() {
            return o.toObject(["type", "rpc" !== this.type && this.type || void 0, "requestType", this.requestType, "requestStream", this.requestStream, "responseType", this.responseType, "responseStream", this.responseStream, "options", this.options])
        }
        ,
        i.prototype.resolve = function() {
    ...
    , function(e, t, r) {
        ...
        function n(e) {
            ...
            for (var r = 0; r < e.fieldsArray.length; ++r) {
                ...
                t("case %i:", n.id),
                n.map ? (t("r.skip().pos++")("if(%s===util.emptyObject)", l)("%s={}", l)("k=r.%s()", n.keyType)("r.pos++"),
                void 0 !== s.long[n.keyType] ? void 0 === s.basic[f] ? t('%s[typeof k==="object"?util.longToHash(k):k]=types[%i].decode(r,r.uint32())', l, r) : t('%s[typeof k==="object"?util.longToHash(k):k]=r.%s()', l, f) : void 0 === s.basic[f] ? t("%s[k]=types[%i].decode(r,r.uint32())", l, r) : t("%s[k]=r.%s()", l, f)) : n.repeated ? (t("if(!(%s&&%s.length))", l, l)("%s=[]", l),
                void 0 !== s.packed[f] && t("if((t&7)===2){")("var c2=r.uint32()+r.pos")("while(r.pos<c2)")("%s.push(r.%s())", l, f)("}else"),
                void 0 === s.basic[f] ? t(n.resolvedType.group ? "%s.push(types[%i].decode(r))" : "%s.push(types[%i].decode(r,r.uint32()))", l, r) : t("%s.push(r.%s())", l, f)) : void 0 === s.basic[f] ? t(n.resolvedType.group ? "%s=types[%i].decode(r)" : "%s=types[%i].decode(r,r.uint32())", l, r) : t("%s=r.%s()", l, f),
                t("break")
            }
    ...
    , function(e, t, r) {
        ...
        function s(e) {
            ...
            for (var a = 0; a < e.fieldsArray.length; ++a) {
                ...
                if (l.optional && t("if(%s!=null&&m.hasOwnProperty(%j)){", u, l.name),
                l.map)
                    t("if(!util.isObject(%s))", u)("return%j", i(l, "object"))("var k=Object.keys(%s)", u)("for(var i=0;i<k.length;++i){"),
                    o(t, l, "k[i]"),
                    n(t, l, a, u + "[k[i]]")("}");
                else if (l.repeated)
                    t("if(!Array.isArray(%s))", u)("return%j", i(l, "array"))("for(var i=0;i<%s.length;++i){", u),
                    n(t, l, a, u + "[i]")("}");
                else {
                    if (l.partOf) {
                        var h = f.safeProp(l.partOf.name);
                        1 === s[l.partOf.name] && t("if(p%s===1)", h)("return%j", l.partOf.name + ": multiple values"),
                        s[l.partOf.name] = 1,
                        t("p%s=1", h)
                    }
                    n(t, l, a, u)
    ...
    , function(e, t, r) {
        ...
        o.toObject = function(e) {
            ...
            for (l = 0; l < t.length; ++l) {
                ...
                n(r, u, d, h + "[ks2[j]]")("}")) : u.repeated ? (r("if(m%s&&m%s.length){", h, h)("d%s=[]", h)("for(var j=0;j<m%s.length;++j){", h),
                n(r, u, d, h + "[j]")("}")) : (r("if(m%s!=null&&m.hasOwnProperty(%j)){", h, u.name),
                n(r, u, d, h),
    ...
    , function(e, t, r) {
        ...
        var a, f, l, u = r(4), h = r(1), c = r(11), d = r(0);
        i.fromJSON = function(e, t) {
            return t || (t = new i),
            ...
            function s(e, t) {
                try {
                    ...
                    d.isString(t)) {
                        ...
                        u.setOptions(t.options).addJSON(t.nested)
                } catch (e) {
                    o(e)
                }
                h || c || o(null, u)
                ...
                if (!(u.files.indexOf(e) > -1)) {
                    ...
                    if (h) {
                        ...
                        d.fetch(e, function(r, n) {
                            if (--c,
                            i)
                                return r ? void (t ? c || o(null, u) : o(r)) : void s(e, n)
                        })
                }
            }
    ...
    , function(e, t, r) {
        ...
        t.VideoEntity = function() {
            function e(t, r) {
                ...
                this.images = {},
                this.sprites = [],
                "object" === (void 0 === t ? "undefined" : n(t)) && t.$type == f ? ("object" === n(t.params) && (this.version = t.ver,
                ...
                this.resetSprites(t)) : t && (t.movie && (t.movie.viewBox && (this.videoSize.width = parseFloat(t.movie.viewBox.width) || 0,
    ...
    , function(e, t, r) {
        ...
        t.FrameEntity = function e(t) {
            ...
            t.clipPath && t.clipPath.length > 0 && (this.maskPath = new n.BezierPath(t.clipPath,void 0,{
                fill: "#000000"
            })),
    ...
    , function(e, t, r) {
        ...
        i.read = function(e, t, r) {
            ...
            for (var i, n = null, o = [], s = 0; t < r; )
                i = e[t++],
                i < 128 ? o[s++] = i : i > 191 && i < 224 ? o[s++] = (31 & i) << 6 | 63 & e[t++] : i > 239 && i < 365 ? (i = ((7 & i) << 18 | (63 & e[t++]) << 12 | (63 & e[t++]) << 6 | 63 & e[t++]) - 65536,
                o[s++] = 55296 + (i >> 10),
    ...
    , function(e, t, r) {
        ...
        function i(e, t, r) {
            return "function" == typeof t ? (r = t,
            t = {}) : t || (t = {}),
            r ? !t.xhr && s && s.readFile ? s.readFile(e, function(n, o) {
                        ...
                        e: for (var f in r.images) {
                            var h = function(i) {
                                if (r.images.hasOwnProperty(i)) {
                                    ...
                                    t.file(f + ".png").async("base64").then(function(o) {
                                        e[i] = o,
                    ...
                    for (var y in r.images)
                        if (r.images.hasOwnProperty(y)) {
                            ...
                            if (e.hasOwnProperty(y))
                                continue;
                            a = !1,
                            t.file(m + ".png").async("base64").then(function(i) {
                                e[y] = i,
                                u._loadImages(e, t, r, n)
                            }
                            .bind(this));
    ...
    , function(e, t, r) {
        ...
        i.prototype.push = function(e, t) {
            var r, i, n, o, u, h, c = this.strm, p = this.options.chunkSize, y = this.options.dictionary, m = !1;
            if (this.ended)
                return !1;
            i = t === ~~t ? t : !0 === t ? l.Z_FINISH : l.Z_NO_FLUSH,
            "string" == typeof e ? c.input = f.binstring2buf(e) : "[object ArrayBuffer]" === d.call(e) ? c.input = new Uint8Array(e) : c.input = e,
            c.next_in = 0,
            c.avail_in = c.input.length;
            do {
                if (0 === c.avail_out && (c.output = new a.Buf8(p),
                c.next_out = 0,
                c.avail_out = p),
                r = s.inflate(c, l.Z_NO_FLUSH),
                r === l.Z_NEED_DICT && y && (h = "string" == typeof y ? f.string2buf(y) : "[object ArrayBuffer]" === d.call(y) ? new Uint8Array(y) : y,
                r = s.inflateSetDictionary(this.strm, h)),
                r === l.Z_BUF_ERROR && !0 === m && (r = l.Z_OK,
                m = !1),
                r !== l.Z_STREAM_END && r !== l.Z_OK)
                    return this.onEnd(r),
                    this.ended = !0,
                    !1;
                c.next_out && (0 !== c.avail_out && r !== l.Z_STREAM_END && (0 !== c.avail_in || i !== l.Z_FINISH && i !== l.Z_SYNC_FLUSH) || ("string" === this.options.to ? (n = f.utf8border(c.output, c.next_out),
                o = c.next_out - n,
                u = f.buf2string(c.output, n),
                c.next_out = o,
                c.avail_out = p - o,
                o && a.arraySet(c.output, c.output, n, o, 0),
                this.onData(u)) : this.onData(a.shrinkBuf(c.output, c.next_out)))),
                0 === c.avail_in && 0 === c.avail_out && (m = !0)
            } while ((c.avail_in > 0 || 0 === c.avail_out) && r !== l.Z_STREAM_END);return r === l.Z_STREAM_END && (i = l.Z_FINISH),
            i === l.Z_FINISH ? (r = s.inflateEnd(this.strm),
            this.onEnd(r),
            this.ended = !0,
            r === l.Z_OK) : i !== l.Z_SYNC_FLUSH || (this.onEnd(l.Z_OK),
            c.avail_out = 0,
            !0)
        }
        ,
    ...
    , function(e, t, r) {
        ...
        function o(e) {
            ...
            t.hold = 0,
            t.bits = 0,
            t.lencode = t.lendyn = new b.Buf32(ye),
        ...
        function a(e, t) {
            ...
            t = -t) : (r = 1 + (t >> 4),
            t < 48 && (t &= 15)),
            t && (t < 8 || t > 15) ? C : (null !== i.window && i.wbits !== t && (i.window = null),
            i.wrap = r,
            i.wbits = t,
            s(e))) : C
        }
        ...
        function c(e, t) {
            var r, n, o, s, a, f, l, c, d, p, y, m, v, ye, me, ve, be, ge, _e, we, ke, xe, Ae, Oe, Se = 0, je = new b.Buf8(4), Te = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
            ...
            e: for (; ; )
                ...
                case Z:
                    ...
                    m > f && (m = f),
                    m && (r.head && (ke = r.head.extra_len - r.length,
                    r.head.extra || (r.head.extra = new Array(r.head.extra_len)),
                    b.arraySet(r.head.extra, n, s, m, ke)),
                ...
                case U:
                    if (2048 & r.flags) {
                        ...
                        } while (ke && m < f);if (512 & r.flags && (r.check = _(r.check, n, m, s)),
                        f -= m,
                        s += m,
                        ke)
                            break e
                ...
                case te:
                    for (; r.have < r.nlen + r.ndist; ) {
                        for (; Se = r.lencode[c & (1 << r.lenbits) - 1],
                        me = Se >>> 24,
                        ve = Se >>> 16 & 255,
                        be = 65535 & Se,
                        !(me <= d); ) {
                ...
                case ie:
                    ...
                    for (r.back = 0; Se = r.lencode[c & (1 << r.lenbits) - 1],
                    me = Se >>> 24,
                    ve = Se >>> 16 & 255,
                    be = 65535 & Se,
                    !(me <= d); ) {
                    ...
                    if (ve && 0 == (240 & ve)) {
                        for (ge = me,
                        _e = ve,
                        we = be; Se = r.lencode[we + ((c & (1 << ge + _e) - 1) >> ge)],
                        me = Se >>> 24,
                        ve = Se >>> 16 & 255,
                        be = 65535 & Se,
                        !(ge + me <= d); ) {
                ...
                case ne:
                    ...
                    r.mode = oe;
                case oe:
                    for (; Se = r.distcode[c & (1 << r.distbits) - 1],
                    me = Se >>> 24,
                    ve = Se >>> 16 & 255,
                    be = 65535 & Se,
                    !(me <= d); ) {
                    ...
                    if (0 == (240 & ve)) {
                        for (ge = me,
                        _e = ve,
                        we = be; Se = r.distcode[we + ((c & (1 << ge + _e) - 1) >> ge)],
                        me = Se >>> 24,
                        ve = Se >>> 16 & 255,
                        be = 65535 & Se,
                        !(ge + me <= d); ) {
                ...
                case le:
                    if (r.wrap) {
                        ...
                        e.total_out += y,
                        r.total += y,
                        y && (e.adler = r.check = r.flags ? _(r.check, o, y, a - y) : g(r.check, o, y, a - y)),
                        y = l,
            ...
            r.hold = c,
            r.bits = d,
            (r.wsize || y !== e.avail_out && r.mode < ce && (r.mode < le || t !== S)) && h(e, e.output, e.next_out, y - e.avail_out) ? (r.mode = de,
            I) : (p -= e.avail_in,
            y -= e.avail_out,
            e.total_in += p,
            e.total_out += y,
            r.total += y,
            r.wrap && y && (e.adler = r.check = r.flags ? _(r.check, o, y, e.next_out - y) : g(r.check, o, y, e.next_out - y)),
            e.data_type = r.bits + (r.last ? 64 : 0) + (r.mode === K ? 128 : 0) + (r.mode === re || r.mode === Y ? 256 : 0),
        ...
        function y(e, t) {
            var r, i, n = t.length;
            return e && e.state ? (r = e.state,
            0 !== r.wrap && r.mode !== H ? C : r.mode === H && (i = 1,
            (i = g(i, t, n, 0)) !== r.check) ? B : h(e, t, n, n) ? (r.mode = de,
            I) : (r.havedict = 1,
            E)) : C
        }
        var m, v, b = r(8), g = r(53), _ = r(54), w = r(55), k = r(56), x = 0, A = 1, O = 2, S = 4, j = 5, T = 6, E = 0, N = 1, F = 2, C = -2, B = -3, I = -4, P = -5, R = 8, D = 1, M = 2, L = 3, z = 4, J = 5, Z = 6, U = 7, q = 8, $ = 9, V = 10, H = 11, K = 12, W = 13, G = 14, Y = 15, X = 16, Q = 17, ee = 18, te = 19, re = 20, ie = 21, ne = 22, oe = 23, se = 24, ae = 25, fe = 26, le = 27, ue = 28, he = 29, ce = 30, de = 31, pe = 32, ye = 852, me = 592, ve = 15, be = !0;
        t.inflateReset = s,
        t.inflateReset2 = a,
    ...
    , function(e, t, r) {
        ...
        e.exports = function(e, t, r, f, l, u, h, c) {
            var d, p, y, m, v, b, g, _, w, k = c.bits, x = 0, A = 0, O = 0, S = 0, j = 0, T = 0, E = 0, N = 0, F = 0, C = 0, B = null, I = 0, P = new i.Buf16(16), R = new i.Buf16(16), D = null, M = 0;
            for (x = 0; x <= 15; x++)
                P[x] = 0;
            for (A = 0; A < f; A++)
                P[t[r + A]]++;
    ...
    , function(e, t, r) {
        ...
        t.string2buf = function(e) {
            ...
            for (o = 0; o < a; o++)
                r = e.charCodeAt(o),
                55296 == (64512 & r) && o + 1 < a && 56320 == (64512 & (i = e.charCodeAt(o + 1))) && (r = 65536 + (r - 55296 << 10) + (i - 56320),
                o++),
        ...
        t.Player = function() {
            ...
            return o(e, [{
                ...
                value: function(e, t, r) {
                    ...
                    this._animator.loops = this.loops <= 0 ? 1 / 0 : 1,
                    this._animator.fillRule = "Backward" === this.fillMode ? 1 : 0,
                    this._animator.onUpdate = function(e) {
                        i._currentFrame !== Math.floor(e) && (i._currentFrame = Math.floor(e),
                        i._update(),
                    ...
                    ,
                    !0 === t ? this._animator.reverse(r) : this._animator.start(r)
                }
            }, {
                key: "_resize",
                value: function() {
                    ...
                    if (void 0 === this._drawingCanvas || !0 === e) {
                        ...
                        if ("Fill" === this._contentMode)
                            ...
                            var w = _.width / _.height
                              , k = g.width / g.height;
                            w >= k && "AspectFit" === this._contentMode || w <= k && "AspectFill" === this._contentMode ? (y = m = g.width / _.width,
                            b = (g.height - _.height * m) / 2) : (w < k && "AspectFit" === this._contentMode || w > k && "AspectFill" === this._contentMode) && (y = m = g.height / _.height,
                            v = (g.width - _.width * y) / 2)
                        }
                    ...
                    if (void 0 === this._bitmapCache) {
                        ...
                        !function() {
                            ...
                            for (t in e._owner._videoItem.images) {
                                var n = e._owner._videoItem.images[t];
                                if (0 === n.indexOf("iVBO") || 0 === n.indexOf("/9j/2w")) {
                                    r++;
                                    var o = document.createElement("img");
                                    o.onload = function() {
                                        ++i == r && (this._prepared = !0,
                            ...
                            if (!(i.alpha < .05)) {
                                ...
                                if ("string" == typeof o) {
                                    var l = t._bitmapCache[e.imageKey] || document.createElement("img")
                                      , u = void 0
                                      , h = void 0;
                                    if (0 === o.indexOf("iVBO") || 0 === o.indexOf("/9j/2w") ? l.src = "data:image/png;base64," + o : (l._svgaSrc !== o && (l._svgaSrc = o,
                                    l.src = o),
                                    u = i.layout.width,
                                    h = i.layout.height),
                                    t._bitmapCache[e.imageKey] = l,
                                    ...
                                    u && h ? r.drawImage(l, 0, 0, u, h) : r.drawImage(l, 0, 0),
                                ...
                                i.shapes && i.shapes.forEach(function(e) {
                                    "shape" === e.type && e.pathArgs && e.pathArgs.d && t.drawBezier(r, new s.BezierPath(e.pathArgs.d,e.transform,e.styles)),
                                    "ellipse" === e.type && e.pathArgs && t.drawEllipse(r, new a.EllipsePath(parseFloat(e.pathArgs.x) || 0,parseFloat(e.pathArgs.y) || 0,parseFloat(e.pathArgs.radiusX) || 0,parseFloat(e.pathArgs.radiusY) || 0,e.transform,e.styles)),
                                    "rect" === e.type && e.pathArgs && t.drawRect(r, new f.RectPath(parseFloat(e.pathArgs.x) || 0,parseFloat(e.pathArgs.y) || 0,parseFloat(e.pathArgs.width) || 0,parseFloat(e.pathArgs.height) || 0,parseFloat(e.pathArgs.cornerRadius) || 0,e.transform,e.styles))
                                });
